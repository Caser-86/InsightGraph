...
This index helps readers find the right InsightGraph document quickly.
...
1. `CONTRIBUTING.md`
2. `docs/roadmap.md`
3. `docs/report-quality-roadmap.md`
4. `docs/research-job-repository-contract.md`
