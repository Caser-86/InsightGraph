...
# CI uploads eval-reports with full, summary, and history eval JSON/Markdown reports.
...
timeline、Live Events、report、tool calls、LLM metadata、Eval Gate metadata、Eval artifact guidance 和 Markdown/HTML 下载。Dashboard 会优先连接
